...
<%
	try {
		...
		String typevalue = session.getAttribute("value").toString();
		...
		String sqlcpHistory = "select * from db_gps.t_unitmasterhistory where UnitID='"	+ getunid + "' and Mobno <> '-' and Simno <> '-'  limit 1";
