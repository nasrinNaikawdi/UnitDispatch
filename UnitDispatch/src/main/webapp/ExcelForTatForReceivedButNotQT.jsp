	...
	if(dispatch.equalsIgnoreCase("Yes")){
		...
		<td  class="sorttable_nosort">
				<div id="report_heding" align="center"><font color="brown" size="3">TAT Report for <%
					...
					<a href="ExcelForTatForReceivedButNotQT.jsp?total=<%=total%>&uidList=<%=unitID_list%>&from=<%=from %>&to=<%=to%>&dispatch=<%=dispatch%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
					...
					//	System.out.println("diffindays----->"+diffdays);
						...
						System.out.println(sql7);
						 ...
						 else
						 {
							 ...
							 qtdate="-";
							 qtby="-";
							 System.out.println("in else Condition ="+unitid);
