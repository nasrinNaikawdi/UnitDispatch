	...
	if(dispatch.equalsIgnoreCase("Yes")){
		...
		<td  class="sorttable_nosort">
				<div id="report_heding" align="center"><font color="brown" size="3">TAT Report for <%
					...
					<a href="ExcelOkButNotDispatched.jsp?total=<%=total%>&from=<%=from %>&to=<%=to%>&dispatch=<%=dispatch%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
...
//					System.out.println("sql==>"+sql);
					...
					//	System.out.println("diffindays----->"+diffdays);
						...
						// System.out.println("entdate"+entdate+"enttime"+enttime+"editedby"+editedby);
						 ...
						 if(testFlag)
						 {
							 System.out.println("in testflag");
							 Date testDate=new Date();
							 if(testDateTime==null||testDateTime.equalsIgnoreCase("null")){
								 System.out.println("in iof of testflag");
							 }else{
								System.out.println("in else of testflag");
						 ...
						 System.out.println("decihr-->"+decihr);
						 ...
						 mintot=decipart*60;
						 System.out.println("mintot-->"+mintot);
						 }
						 //------------------------------------------------------------------------------------------------
						 ...
						 //----------------getting the dispatch date--------------------------
							 ...
							 {
						 		System.out.println("in if function of tested");
