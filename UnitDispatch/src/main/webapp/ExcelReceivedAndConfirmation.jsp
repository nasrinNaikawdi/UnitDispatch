	...
	if(dispatch.equalsIgnoreCase("Yes")){
		...
		<td  class="sorttable_nosort">
				<div id="report_heding" align="center"><font color="brown" size="3">TAT Report for <%
					...
					<a href="ExcelReceivedAndConfirmation.jsp?total=<%=total%>&from=<%=from %>&to=<%=to%>&dispatch=<%=dispatch%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
...
//					System.out.println("sql==>"+sql);
					...
					//	System.out.println(sql7);
						...
						if(rsget1.next())
						{
							...
							System.out.println(RecByTech);
							RecByCust=rsget1.getString("RecByCust");
							System.out.println(RecByCust);
							...
							if(((RecByTech.equalsIgnoreCase("yes"))||(RecByCust.equalsIgnoreCase("yes")))){
							//	System.out.println("if unit is here it shouls print");
								 ...
								 if(!(dispdate.equals("-")) && !receiveddate.equals("-"))
								 {
									...
									diffdayrec=(diffdisp / (1000*60*60*24));
									 ...
									 System.out.println("decihr1----->"+decihr1);
									 System.out.println("diffinhrsdisp----->"+diffinhrsdisp);
