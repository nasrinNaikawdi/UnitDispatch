...
if(dispatch.equalsIgnoreCase("Yes")){
	...
	<td  class="sorttable_nosort">
			<div id="report_heding" align="center"><font color="brown" size="3">TAT Report for <%
				...
				<a href="TATReport_export.jsp?total=<%=total%>&uidList=<%=unitID_list%>&data=<%=from %>&data1=<%=to%>&dispatch=<%=dispatch%>"  title="Export to Excel"><img src="images/excel.jpg" width="15px" height="15px"></a> 
