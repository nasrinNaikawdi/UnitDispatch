...
String data="",data1="",vendor="",Statustype="",technician="",metal="",plastic="",airtel="",idea="",vodafone="";
...
metal=request.getParameter("metal");
plastic=request.getParameter("plastic");
airtel=request.getParameter("airtel");
vodafone=request.getParameter("vodafone");
...
%>
	...
	<table border="1" width="100%">
		<tr>
			<td align="center"> <font color="blue" size="2"> <B> Unit Summary Report </B> </font> </td>
		</tr>
		<tr>
...
<%int c1=1, i=1;
	if(metal!=null)
		sql1="select * from t_unitmaster where EntDate between '"+data+"'and '"+data1+"' and InstType ='"+Statustype+"' and HoldBy='"+vendor+"' and Box_type='Metal'";
	else if(plastic!=null)
		sql1="select * from t_unitmaster where EntDate between '"+data+"'and '"+data1+"' and InstType ='"+Statustype+"' and HoldBy='"+vendor+"' and Box_type='Plastic'";
	else if(airtel!=null)
		sql1="select * from t_unitmaster where EntDate between '"+data+"'and '"+data1+"' and InstType ='"+Statustype+"' and HoldBy='"+vendor+"' and SimCompany='Airtel'";
	else if(idea!=null)
		sql1="select * from t_unitmaster where EntDate between '"+data+"'and '"+data1+"' and InstType ='"+Statustype+"' and HoldBy='"+vendor+"' and SimCompany='Idea'";
	else if(vodafone!=null)
		sql1="select * from t_unitmaster where EntDate between '"+data+"'and '"+data1+"' and InstType ='"+Statustype+"' and HoldBy='"+vendor+"' and SimCompany='Vodafone'";
	else
	sql1="select * from t_unitmaster where EntDate between '"+data+"'and '"+data1+"' and InstType ='"+Statustype+"' and HoldBy='"+vendor+"' ";
