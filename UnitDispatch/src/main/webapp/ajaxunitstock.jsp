...
String data="",data1="",vendor="",Statustype="",technician="",received="",sent="",faultyyes="",faultyno="";
...
received=request.getParameter("received");
sent=request.getParameter("sent");
faultyyes=request.getParameter("faultyyes");
faultyno=request.getParameter("faultyno");
...
%>
	...
	<table border="1" width="100%">
		<tr>
			<td align="center"> <font color="blue" size="2"> <B> Unit Stock Details </B> </font> </td>
		</tr>
		<tr>
			<td align="center" colspan="14"> <font color="maroon" size="2"> <B> 
			Unit Stock Details for <%
                       ...
                       String showdate1 = formatter1.format(ShowDate1);*/
                        out.print("Vendor:"+vendor+"&nbsp;&nbsp; Status Type:"+Statustype); %></font></div>
...
<%int c1=1, i=1;
	...
	if(vendor.equalsIgnoreCase("all"))
	{
		...
		{
			if(received!=null)
				sql2="select * from t_unitmaster where Status='Received'";
			else if(sent!=null)
				sql2="select * from t_unitmaster where Status='Sent'";
			else if(faultyyes!=null)
				sql2="select * from t_unitmaster where testedunit='No'";
			else if(faultyno!=null)
				sql2="select * from t_unitmaster where testedunit='Yes'";
			else
				sql2="select * from t_unitmaster";
		}
		else
		{
			if(received!=null)
				sql2="select * from t_unitmaster where InstType ='"+Statustype+"' and Status='Received'";
			else if(sent!=null)
				sql2="select * from t_unitmaster where InstType ='"+Statustype+"' and Status='Sent'";
			else if(faultyyes!=null)
				sql2="select * from t_unitmaster where InstType ='"+Statustype+"' and testedunit='No'";
			else if(faultyno!=null)
				sql2="select * from t_unitmaster where InstType ='"+Statustype+"' and testedunit='Yes'";
			else
			sql2="select * from t_unitmaster where InstType ='"+Statustype+"'";
	...
	else
	{
		...
		{
			if(received!=null)
				sql2="select * from t_unitmaster where HoldBy='"+vendor+"' and Status='Received'";
			else if(sent!=null)
				sql2="select * from t_unitmaster where HoldBy='"+vendor+"' and Status='Sent'";
			else if(faultyyes!=null)
				sql2="select * from t_unitmaster where HoldBy='"+vendor+"' and testedunit='No'";
			else if(faultyno!=null)
				sql2="select * from t_unitmaster where HoldBy='"+vendor+"' and testedunit='Yes'";
			else
			sql2="select * from t_unitmaster where HoldBy='"+vendor+"' ";

		}
		else
		{
			if(received!=null)
				sql2="select * from t_unitmaster where InstType ='"+Statustype+"' and HoldBy='"+vendor+"' and Status='Received'";
			else if(sent!=null)
				sql2="select * from t_unitmaster where InstType ='"+Statustype+"' and HoldBy='"+vendor+"' and Status='Sent'";
			else if(faultyyes!=null)
				sql2="select * from t_unitmaster where InstType ='"+Statustype+"' and HoldBy='"+vendor+"' and testedunit='No'";
			else if(faultyno!=null)
				sql2="select * from t_unitmaster where InstType ='"+Statustype+"' and HoldBy='"+vendor+"' and testedunit='Yes'";
			else
			sql2="select * from t_unitmaster where InstType ='"+Statustype+"' and HoldBy='"+vendor+"' ";
