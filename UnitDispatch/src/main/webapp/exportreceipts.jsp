...
<% response.setContentType("application/vnd.ms-excel");
	response.addHeader("Content-Disposition","attachment;filename=\"printreceipt_external.xls\"");%>
...
String ordrdte="", add="", status="", dispdte="", ordqty="", dispdte1="", mode="", modename="", chalanno="",isnttype="",dispby="", ordby="" ;
...
%>
   ...
   <!--  <a href="http://www.bcgen.com/demo/linear-dbgs.aspx?Barcode=123456"> click </a> -->
<%
