...
Statement stmt1=con1.createStatement(), stmt2=con1.createStatement(),stmtVendor = con1.createStatement();
...
<% } %>
<%
  if(ustyp.equals("administrator") && vendoreRole.equalsIgnoreCase("administrator"))
   { 
      sql1="select * from t_unitorder where Status in('Open', 'Partially Dispatched','Partially Sent') order by Reqno desc ";
   }
   else if(ustyp.equals("administrator") && vendoreRole.equalsIgnoreCase("manufacturer"))
   { 
