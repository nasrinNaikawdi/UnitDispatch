...
if(rs1.next())
{
  ...
  String vendorType = "Select V_Role from t_vendorMaster where V_ID = '"+typeval+"'";
  System.out.println("query--"+vendorType);
  ResultSet rsV_Role = stmt2.executeQuery(vendorType);
  String vrole = "";
  if(rsV_Role.next())
  {
	  vrole = rsV_Role.getString("V_Role");
  }
  System.out.println("t_admin--"+manuf);
  System.out.println("t_vendorMaster---"+vrole);
  
  if(manuf.equals("manufacturer") && vrole.equals("manufacturer") || manuf.equals("administrator") && vrole.equals("manufacturer") || manuf.equals("manufacturer") && vrole.equals("administrator"))
  {
     response.sendRedirect("main.jsp?&empname="+empname);
     return;
  }
  //else if(manuf.equals("administrator"))
  else if(manuf.equals("administrator") && vrole.equals("administrator"))
  {
     response.sendRedirect("main.jsp?&empname="+empname);
     return;
  }
